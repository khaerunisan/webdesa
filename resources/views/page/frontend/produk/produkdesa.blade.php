    ...
    <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="ppid" class="nav-item nav-link ">PPID </i>
                </a>
            </div>
        </div>
    </nav>
...
<div class="container-fluid py-6 px-5">
    ...
    <div class="text-center mx-auto mb-5" style="max-width: 600px;">
        ...
        <h4>Layanan Promosi UMKM desa disediakan untuk membantu pelaku usaha memperluas pemasaran meningkatkan data saing, dan mengenalkan produk unggulan desa, 
            sehingga dapat mendorong peningkatan per ekonomian masyarakat.</h4>
    </div>
